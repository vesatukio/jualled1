...
(function(){
'use strict';
var deferredPrompt=null,KEY='dutaled_pwa_install_closed_v2',bar,installBtn,closeBtn,bound=false;
...
function init(){
  ...
  installBtn.addEventListener('click',async function(){
    if(!deferredPrompt){
      alert('Aplikasi belum bisa di-install otomatis. Jika memakai Chrome Android, buka menu ⋮ lalu pilih “Tambahkan ke layar utama” atau “Install app”.');
      return;
    }
