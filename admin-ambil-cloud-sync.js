...
function watchAmbilSort(){const l=document.getElementById('abfList');if(!l||l.dataset.dateSort)return;l.dataset.dateSort='1';const mo=new MutationObserver(()=>sortAmbilByTanggal());mo.observe(l,{childList:true});sortAmbilByTanggal()}
