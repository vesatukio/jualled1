 ...
 * Katalog cepat dari Supabase dengan fallback otomatis ke Google Apps Script.
 */
(() => {
  "use strict";
  ...
  window.fetch = async function(input, init) {
    ...
    if (url && url.startsWith(OLD_API_PREFIX)) {
      try {
        ...
        // Supabase gagal (CORS, jaringan, RLS, timeout, dll). Jangan biarkan katalog mati.
        // Kembalikan request ke Google Apps Script sebagai sumber cadangan.
        console.warn("Supabase katalog gagal, gunakan Google Apps Script:", error?.message || error);
