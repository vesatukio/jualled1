...
(function(){
  ...
  async function submitOrder(e){
    ...
    if(!db)return alert("Koneksi pesanan belum siap. Silakan refresh halaman.");
  ...
  document.addEventListener("DOMContentLoaded",()=>{
    ...
    if(b){
      ...
      b.addEventListener("click",e=>{e.preventDefault();openCheckout()});
      /* Capture phase prevents the old app.js WhatsApp handler from running. */
      b.addEventListener("click",e=>{e.preventDefault();e.stopImmediatePropagation();openCheckout()},{capture:true});
    }
